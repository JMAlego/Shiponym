 ...
 * and possibly middle name(s). Can do simple operations such as tell if the name
 * is double barrelled. Can iterate over each element in the name, in order first
 * to last.
 * @author Jacob Allen
 * 
 */
public class Name implements Iterable<String> {
	 ...
	 * @param full_name the full name (with spaces)
	 */
	...
	/**
	 * Creates an instance of Name from strings containing a first name,
	 * and a last name.
	...
	/**
	 * Creates an instance of Name from strings containing a fist name,
	 * middle names (with spaces between them), and a last name.
	 * @param first_name the first name
	 * @param middle_names the middle names (with spaces if needed)
	 * @param last_name the last name
	 */
	...
	/**
	 * Gets a randomly selected last name if the name is double barrelled,
	 * else just returns the last name as a string.
